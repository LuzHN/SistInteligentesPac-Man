...
################################ INTRO FUNCTIONS ########################
    ...
    def start_draw(self):
        ...
        [WIDTH//2, HEIGHT//2 + 50], START_TEXT_SIZE, (33,137,156), START_FONT, centered=True)

        self.draw_text('© UNITEC 2019 Sist. Inteligentes', self.screen, 
        [WIDTH//2, HEIGHT//2 + 100], START_TEXT_SIZE, (255,255,255), START_FONT, centered=True)
...
################################ PLAYING   FUNCTIONS ########################
    ...
    def playing_draw(self):
        ...
        self.draw_grid()
        self.draw_text('CURRENT SCORE: 0', 
